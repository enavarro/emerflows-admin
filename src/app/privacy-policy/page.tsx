    ...
    <div className='min-h-screen px-4 py-12 sm:px-6 lg:px-8'>
      <div className='mx-auto max-w-3xl space-y-8'>
        ...
        <section>
          ...
          <p className='text-muted-foreground text-base leading-relaxed'>
            Our application uses Supabase Auth to handle user authentication securely. All
            authentication processes, including sign-in and password management, are managed by
            Supabase. Your authentication data is stored securely and protected with
